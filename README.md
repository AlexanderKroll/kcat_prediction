...
Before you can run the jupyter notebooks, you need to download and unzip a [data folder from Zenodo](https://doi.org/10.5281/zenodo.7755311). Afterwards, this repository should have the following strcuture:
